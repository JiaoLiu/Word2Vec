...
@property (nonatomic, assign)double descentRate; // default is 0.05
@property (nonatomic, assign)int windowSize; // default is 5
@property (nonatomic, assign)bool isHS; // default is Yes
@property (nonatomic, assign)int negativeSeed; //default is 5
